      ...
      <ul className="nav col-12 col-md-auto justify-content-center main-menu">
        ...
        <li className="nav-item dropdown">
          <a
            ...
            className="nav-link services-dropdown-toggle dropdown-toggle d-flex justify-content-between margin-right-5"
            href="#"
            role="button"
            data-bs-toggle="dropdown"
            aria-expanded="false"
          ...
          <div className="dropdown-menu border-0 rounded-custom shadow py-0 bg-white">
            <div className="dropdown-grid rounded-custom width-full">
              <div className="dropdown-grid-item">
                <h6 className="drop-heading">Web Development</h6>
                {navServicesWeb.map((navLink, i) => (
                  <span key={i + 1}>
              ...
              <div className="dropdown-grid-item radius-right-side bg-light">
                <h6 className="drop-heading">App Development</h6>
                {navServicesApp.map((navPage, i) => (
                  <span key={i + 1}>
